...
"[project]/.next-internal/server/app/api/fsn/enquiries/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/app/api/fsn/enquiries/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const [rows] = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute(`
      SELECT 
    ...
    `, [
        ...
        if (Array.isArray(rows) && rows.length > 0) {
            ...
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]('Enquiry not found', {
                status: 404
            });
        }
    } catch (error) {
        console.error('Database error:', error);
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]('Failed to fetch enquiry', {
            status: 500
        });
    }
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c465e525._.js.map