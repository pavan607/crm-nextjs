...
async function POST(req) {
    try {
        ...
        const [rows] = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute(`SELECT employee_id, employee_number, employee_email, employee_first_name, employee_last_name, employee_dob 
       FROM crm_employee 
       WHERE employee_number = ? AND employee_email = ? AND employee_dob = ?`, [
        ...
        if (rows.length > 0) {
            ...
            (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cookies"])()).set("loggedIn", "true", {
                httpOnly: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a7a21ca5._.js.map