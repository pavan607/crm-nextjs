...
(()=>{
    const e = new Error("Cannot find module 'react-data-table-component'");
...
function LeadListPage() {
    ...
    const renderBreadcrumb = ()=>{
        const isLeadList = currentPath.includes('/leads/leadlist');
        const isLeadForm = currentPath === '/leads' || currentPath.includes('/leads/') && !currentPath.includes('/leadlist');
        if (isLeadList) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchLeads = async ()=>{
            try {
                const res = await fetch('/api/leadlist');
    ...
    const handleEdit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((leadId)=>{
        router.push(`/leads/${leadId}/edit`);
    }, [
        router
    ]);
    const handleDelete = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (leadId)=>{
        try {
            const response = await fetch(`/api/leads/${leadId}`, {
                method: 'DELETE'
            });
            if (response.ok) {
                const updatedLeads = leads.filter((lead)=>lead.leadId !== leadId);
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                onClick: ()=>{
                                    if (deleteModal.leadId) {
                                        handleDelete(deleteModal.leadId);
                                    }
                                },
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(DataTable, {
                ...
                responsive: true,
                pointerOnHover: true,
                onRowClicked: (row)=>router.push(`/leads/${row.leadId}`),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c00207d9._.js.map