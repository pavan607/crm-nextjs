...
const LeadForm = ()=>{
    const { employee, loading: sessionLoading, requireAuth } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$hooks$2f$useEmployeeSession$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEmployeeSession"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        fetch('/api/enquiry/employee_dropdown').then((res)=>res.json()).then((data)=>setEmployees(data)).catch((err)=>console.error('Failed to load employees:', err));
        fetch('/api/enquiry/product_dropdown').then((res)=>res.json()).then((data)=>setProducts(data)).catch((err)=>console.error('Failed to load products:', err));
    }, [
        sessionLoading,
        requireAuth
    ]);
...
//# sourceMappingURL=app_8acc38a4._.js.map