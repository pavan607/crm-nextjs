...
"[project]/app/enquiry/edit/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function LeadEditPage(param) {
    ...
    const { leadId } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["use"])(params);
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    ...
    const logSessionData = ()=>{
        const sessionProducts = sessionStorage.getItem("enquiryProducts_".concat(leadId));
        if (sessionProducts) {
        ...
        "LeadEditPage.useEffect": ()=>{
            ...
            async function fetchData() {
                ...
                try {
                    ...
                    const cachedLeadData = sessionStorage.getItem("leadData_".concat(leadId));
                    // eslint-disable-next-line @typescript-eslint/no-unused-vars
                    const cachedEnquiryProducts = sessionStorage.getItem("enquiryProducts_".concat(leadId));
                    ...
                    if (cachedLeadData) {
                        ...
                        const leadRes = await fetch("/api/leads/".concat(leadId, "/edit_old"));
                        if (!leadRes.ok) {
                            const errorData = await leadRes.json();
                            throw new Error(errorData.message || 'Lead not found.');
                        }
                        leadData = await leadRes.json();
                        sessionStorage.setItem("leadData_".concat(leadId, "/edit_old"), JSON.stringify(leadData));
                    }
                    ...
                    if (mappedLead.products) {
                        ...
                        sessionStorage.setItem("enquiryProducts_".concat(leadId), JSON.stringify(finalEnquiryProducts));
                    }
    ...
    const handleSaveProduct = (product)=>{
        ...
        sessionStorage.setItem("enquiryProducts_".concat(leadId), JSON.stringify(updatedProducts));
        sessionStorage.setItem("enquiryProducts_lastUpdated_".concat(leadId), new Date().toISOString());
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            console.log('Making API call to:', "/api/leads/".concat(leadId, "/edit_old"));
            const response = await fetch("/api/leads/".concat(leadId, "/edit_old"), {
                method: 'PUT',
                body: payload
            });
            if (!response.ok) {
            ...
            try {
                sessionStorage.removeItem("enquiryProducts_".concat(leadId));
                sessionStorage.removeItem("enquiryProducts_lastUpdated_".concat(leadId));
                sessionStorage.removeItem("leadData_".concat(leadId));
            ...
            setTimeout(()=>{
                router.push("/leads/".concat(leadId));
            }, 100);
        } catch (error) {
...
//# sourceMappingURL=app_186c1f07._.js.map