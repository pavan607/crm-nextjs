...
const LeadForm = ()=>{
    ...
    const renderBreadcrumb = ()=>{
        ...
        const isLeadList = pathname.includes('/leads/leadlist');
        const isLeadForm = pathname === '/leads' || pathname.includes('/leads/') && !pathname.includes('/leadlist');
        if (isLeadList) {
...
//# sourceMappingURL=app_enquiry_add_page_tsx_9768a3f4._.js.map